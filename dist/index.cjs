...
__export(src_exports, {
  isKoinError: () => isKoinError,
  sendClientError: () => sendClientError
});
module.exports = __toCommonJS(src_exports);

// src/koinError/index.ts
function isKoinError(error) {
  try {
    return error.type === "KOIN_ERROR";
  } catch {
    return false;
  }
}

// src/sendClientError/index.ts
var import_axios = __toESM(require_axios2(), 1);
var sendClientError = (error) => {
  ...
  import_axios.default.post("https://api-slack.internal.bcsdlab.com/api/error-notice/frontend", {
    url,
